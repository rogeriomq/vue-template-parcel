...
},{}],"components/Hello.vue":[function(require,module,exports) {
'use strict';
...
exports.default = {
  ...
  debug: true,
  mounted: function mounted() {
    this.log('Hello.vue Mounted!');
  }
};
        var $b83480 = exports.default || module.exports;
      
      if (typeof $b83480 === 'function') {
        $b83480 = $b83480.options;
      }
    
        /* template */
        Object.assign($b83480, (function () {
          var render = function() {
  var _vm = this
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "border-test1" }, [
      _c("h2", { staticClass: "border-test2" }, [
        _vm._v("Hello Vue Project With Parcel!")
      ]),
      _vm._v(" "),
      _c("h4", { staticClass: "border-test3" }, [
        _c("b", [_vm._v("I'm loving Parcel. Quick and simple!")])
      ])
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b83480', $b83480);
          } else {
            api.reload('$b83480', $b83480);
          }
        }
...
exports.default = {
  ...
  debug: true,
  mounted: function mounted() {
    this.log('App.vue Mounted!');
    this.warn('To disable this log, set prop debug = false...');
  }
}; //
//
//
...
//
//
        var $5c79bb = exports.default || module.exports;
      
      if (typeof $5c79bb === 'function') {
        $5c79bb = $5c79bb.options;
      }
    
        /* template */
        Object.assign($5c79bb, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5c79bb', $5c79bb);
          } else {
            api.reload('$5c79bb', $5c79bb);
          }
        }
...
},{"./components/Hello":"components/Hello.vue","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/mixins/debugMixin.js":[function(require,module,exports) {
'use strict';
...
function _log(type) {
  ...
  if (this.$options.debug) {
    ...
    (_console = console)[type].apply(_console, ['%c[' + this.$_id + ']>>', 'background:' + (type === 'log' ? '#384A5E' : type === 'warn' ? '#F1BF39' : '#FF5370') + '; padding: 3px; border-radius: 3px;  color: #fff'].concat(args, [this.$el]));
  }
}
...
exports.default = {
  ...
  methods: {
    log: function log() {
      ...
      _log.call.apply(_log, [this, 'log'].concat(_toConsumableArray(args)));
    },
    warn: function warn() {
      ...
      _log.call.apply(_log, [this, 'warn'].concat(_toConsumableArray(args)));
    },
    err: function err() {
      ...
      _log.call.apply(_log, [this, 'error'].concat(_toConsumableArray(args)));
    }
  }
};
},{}],"plugins/debug.js":[function(require,module,exports) {
'use strict';
...
var _debugMixin = require('../components/mixins/debugMixin');

var _debugMixin2 = _interopRequireDefault(_debugMixin);
...
exports.default = function (_ref) {
  ...
  Vue.mixin(_debugMixin2.default);
};
},{"../components/mixins/debugMixin":"components/mixins/debugMixin.js"}],"../node_modules/axios/lib/helpers/bind.js":[function(require,module,exports) {
'use strict';
...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"plugins/axios.js":[function(require,module,exports) {
'use strict';
...
},{"axios":"../node_modules/axios/index.js"}],"plugins/index.js":[function(require,module,exports) {
'use strict';
...
plugins.push(_debug2.default);

plugins.push(_axios2.default);

exports.default = function (_ref) {
  var Vue = _ref.Vue;

  plugins.forEach(function (plugin) {
    return plugin({ Vue: Vue });
  });
};
},{"./debug":"plugins/debug.js","./axios":"plugins/axios.js"}],"css/theme.styl":[function(require,module,exports) {
...
(0, _plugins2.default)({ Vue: _vue2.default });
...
},{"vue":"../node_modules/vue/dist/vue.runtime.esm.js","./App":"App.vue","./plugins":"plugins/index.js","./css/theme.styl":"css/theme.styl"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/main.9cfb8d06.map